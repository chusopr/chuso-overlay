...
IUSE="db2 dbexpress doc gnome informix kde mozilla mysql oracle postgres"
DEPEND="virtual/libc
		>=media-libs/jpeg-6b
		>=x11-libs/gtk+-1.2
...
src_install() {
	...
	use postgres || sed -is 's/Postgres" install="true/Postgres" install="false/' setup.data/setup.portage.xml
