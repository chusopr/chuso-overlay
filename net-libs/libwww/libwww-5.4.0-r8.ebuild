...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libwww/Attic/libwww-5.4.0-r8.ebuild,v 1.2 2012/11/18 13:52:38 kensington dead $
...
SRC_URI="http://www.w3.org/Library/Distribution/${MY_P}.tgz
		http://chuso-overlay.forja.rediris.es/distfiles/${P}-patches-${PATCHVER}.tar.bz2"
