...
SRC_URI="
	...
	http://ffmpeg.org/releases/ffmpeg-${FF_VERSION}.tar.bz2
	"
LICENSE="Spotify LGPL-2.1 LGPL-3"
SLOT="0"
KEYWORDS="~amd64"

FFMPEG_FLAG_MAP=(
		+bzip2:bzlib cpudetection:runtime-cpudetect debug gcrypt gmp
		+hardcoded-tables lzma
		+zlib
		# decoders
...
IUSE="libnotify libressl systray pax_kernel pulseaudio ${FFMPEG_IUSE}"
...
src_install() {
	...
	FF_LD_PATH=":/opt/spotify/spotify-client"
